...
- **LOCATION Colombia / LatAm.** Strongly prefer remote / online / worldwide-eligible.
  In-person US/EU events are OK ONLY if participation can be remote, OR travel+visa are
  provided/sponsored, OR no relocation is required. DROP anything requiring US work
  authorization, US/EU citizenship, or residency he doesn't have. Spanish-language and
  LatAm-regional programs are a plus.
...
- **leverageScore 5** = remote/global (or LatAm-eligible), open to a 17-year-old undergrad,
  ...
  scholarship for LatAm undergrads.
