...
export const PHASES: PhaseDefinition[] = [
  ...
  },
  {
    ...
    shortName: 'Outbound',
    duration: 'Weeks 2-4',
    description: '5 people actively trying Nella by end of Week 4.',
    exitCriteria: [
      { key: 'users5', label: '5+ people actively using Nella' },
  ...
  },
  {
    ...
    timeBlocks: [
      ...
      { duration: '45 min', task: 'Create 2 posts/week for X. Use real data from Nella.' },
