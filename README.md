...
<p align="center">
  ...
  <img alt="MCP 78 tools" src="https://img.shields.io/badge/MCP-78_tools-c8542a?style=flat" />
...
├── mcp-server/          # 78-tool MCP over the localhost API (stdio | --http)
