...
- [ ] **Step 4: Implement the course selector**
...
- [ ] **Step 5: Run the new test and confirm GREEN**

Run: `npx tsx --test scripts/student-workspace-shell.test.mts`

Expected: all shell tests pass.

- [ ] **Step 6: Commit tests and components separately**
...
- [ ] **Step 1: Write failing workspace markup tests**
...
- [ ] **Step 3: Implement assignment table and cards**
...
- [ ] **Step 4: Implement due soon and filters**
...
- [ ] **Step 6: Commit in test and production slices**
...
- [ ] **Step 3: Move course details into the drawer component**
...
- [ ] **Step 4: Remove the old local CourseDetail implementation**
...
- [ ] **Step 1: Replace the old hero test with integration source assertions**
...
- [ ] **Step 3: Wire status updates through the pure helper**
...
- [ ] **Step 4: Replace the page layout**
...
- [ ] **Step 5: Preserve add and navigation flows**
...
- [ ] **Step 3: Capture three screenshots**
